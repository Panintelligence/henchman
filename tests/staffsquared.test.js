  ...
  describe('getNamesInDateRange', () => {
    ...
    it('should only gets the names within the date range', () => {
      assert.deepEqual(staffsquared.getNamesInDateRange(absentees, {
        ...
        ` * (Working Remotely) **Jane Doe** (2018-10-29 08:30:00 to 2018-11-02 17:00:00)`,
        ` * (Working Remotely) **John Doe** (2018-11-01 08:30:00 to 2018-11-01 17:00:00)`,
      ]);
      ...
      assert.deepEqual(staffsquared.getNamesInDateRange(absentees, {
        ...
        ` * (Working Remotely) **Sarah Kerrigan** (2018-11-10 10:00:00 to 2018-12-01 17:00:00)`,
        ` * (Working Remotely) **Sylvanas Windrunner** (2018-11-05 08:30:00 to 2018-11-15 17:00:00)`,
      ]);
      ...
      assert.deepEqual(staffsquared.getNamesInDateRange(absentees, {
        ...
        ` * (Holiday) **Orgrim Doomhammer** (2018-10-31 08:30:00 to 2018-10-31 17:00:00)`,
        ` * (Working Remotely) **Jane Doe** (2018-10-29 08:30:00 to 2018-11-02 17:00:00)`,
      ]);
    });
